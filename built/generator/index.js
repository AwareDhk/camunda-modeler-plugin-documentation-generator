...
export const generateWordDocumentationFromBpmn = (bpmnFile, template) => __awaiter(void 0, void 0, void 0, function* () {
    const processDiagrams = yield buildJsonFromBpmnXml(bpmnFile);
